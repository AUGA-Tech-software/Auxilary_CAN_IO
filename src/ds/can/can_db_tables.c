...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
{   CAN_BUS_0                ,0x18A7035A           ,1                 ,0              ,100               ,100               ,8                    ,0                ,NONE                      ,0x0                  ,0                  ,0                   ,0                ,0               },  //AUXIO2_TCM_CMD             
{   CAN_BUS_0                ,0x18FED903           ,1                 ,0              ,100               ,100               ,8                    ,1                ,NONE                      ,0x0                  ,0                  ,0                   ,0                ,0               },  //AUXIO1_TCM_STATUS          
{   CAN_BUS_0                ,0x189D5A03           ,1                 ,0              ,100               ,100               ,8                    ,1                ,NONE                      ,0x0                  ,0                  ,0                   ,0                ,0               },  //AUXIO6_CURRENTS            
};
 ...
 volatile const can_bus_db_const_typ can_bus_db_const[CAN_BUS_MAX+1]__attribute__((section(".rodata#"))) = 
{
 ...
 //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 {            CAN_BUS_0             , TRUE                         , FALSE                            , BIOS_CAN_250KBIT          , IS_NO_GW_INPUT          , {           "250 kBit"          , 3                , 15                 , 3                , 3                , 0                , 0                 }, {           ""                    , 0                , 0                     , 0                  , 0                  , 0                   , 0                } , 0                     }          , 
 {            CAN_BUS_1             , TRUE                         , FALSE                            , BIOS_CAN_250KBIT          , IS_NO_GW_INPUT          , {           "250 kBit"          , 3                , 15                 , 3                , 3                , 0                , 0                 }, {           ""                    , 0                , 0                     , 0                  , 0                  , 0                   , 0                } , 0                     }          , 
